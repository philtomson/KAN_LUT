# examples/JSC_OpenML/FPGA/generate_mem_files.jl
...
layer1_json = joinpath(@__DIR__, "..", "jsc_luts_layer1.json")
layer2_json = joinpath(@__DIR__, "..", "jsc_luts_layer2.json")

generate_layer_mems(layer1_json, 1, P, 16, out_dir)
